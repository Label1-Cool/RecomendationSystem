...
{
    /// <summary>
    /// Вспомогательтный класс для извлечения информации из бд и представления ее в удобном для дальнейшей обработки методами виде. Singleton.
    /// </summary>
    public sealed class DataAnalyzer
    {
        ...
        private UserToEducationLineCell[,] CreateUserToEducationLineMatrix()
        {
            ...
            for (int i = 0; i < allUserCluster.GetLength(0); i++)
            {
                ...
                {
                    Id = allUserCluster[i, 0].UserId,
                    Name = allUserCluster[i, 0].UserName,
